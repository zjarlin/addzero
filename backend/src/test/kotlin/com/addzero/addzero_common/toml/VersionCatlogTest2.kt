package com.addzero.addzero_common.toml
...
// 在 [plugins] 标记后追加新插件
    ...
    fun 融合toml(): Unit {
        val loopFiles =
            cn.hutool.core.io.FileUtil.loopFiles("/Users/zjarlin/IdeaProjects/second-brain/backend/src/test/kotlin/com/addzero/addzero_common/toml/need_merge_toml")
