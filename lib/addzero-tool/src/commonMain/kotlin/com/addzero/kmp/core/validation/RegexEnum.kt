package com.addzero.kmp.core.validation
...
enum class RegexEnum(val pattern: String, val message: String) {
    ...
    TIME_MINUTE("^([01]\\d|2[0-3]):[0-5]\\d$", "请输入正确的时间格式：HH:mm"),
    DATETIME("^\\d{4}-(0[1-9]|1[0-2])-(0[1-9]|[12]\\d|3[01])\\s([01]\\d|2[0-3]):[0-5]\\d:[0-5]\\d$", "请输入正确的日期时间格式：yyyy-MM-dd HH:mm:ss"),
    DATETIME_MINUTE("^\\d{4}-(0[1-9]|1[0-2])-(0[1-9]|[12]\\d|3[01])\\s([01]\\d|2[0-3]):[0-5]\\d$", "请输入正确的日期时间格式：yyyy-MM-dd HH:mm"),
    ...
    companion object Companion {
        fun validate(input: String?, pattern: RegexEnum): Pair<Boolean, String> {
