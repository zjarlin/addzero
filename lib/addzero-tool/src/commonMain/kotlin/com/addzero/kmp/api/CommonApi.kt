 ...
 * 返回类型: kotlin.collections.List<com.addzero.kmp.entity.low_table.StateColumnMetadata>
 */
    @GET("/common/getColumns")    suspend fun getColumns(
        @Query("tableName") tableName: kotlin.String
    ): kotlin.collections.List<com.addzero.kmp.entity.low_table.StateColumnMetadata>
