 ...
 * HTTP方法: GET
 * 路径: /sysUser/page
 * 返回类型: com.addzero.kmp.entity.PageResult<com.addzero.kmp.generated.isomorphic.SysUserIso>
 */
    @GET("/sysUser/page")    suspend fun page(): com.addzero.kmp.entity.PageResult<com.addzero.kmp.generated.isomorphic.SysUserIso>
 ...
 * 返回类型: kotlin.collections.List<com.addzero.kmp.generated.isomorphic.SysUserIso>
 */
    @GET("/sysUser/tree")    suspend fun tree(
        @Query("keyword") keyword: kotlin.String
    ): kotlin.collections.List<com.addzero.kmp.generated.isomorphic.SysUserIso>
