    ...
    val defaultRenderMap = linkedMapOf<String, @Composable () -> Unit>(
        ...
        SysMenuFormProps.title to {
            AddTextField(
                ...
                onValueChange = {
                    state.value = state.value.copy(title = if (it.isBlank()) null else it.parseObjectByKtx())
                },
                label = "路由标题",
                isRequired = false
            )
        ...
        SysMenuFormProps.routePath to {
            AddTextField(
                ...
                onValueChange = {
                    state.value = state.value.copy(routePath = if (it.isBlank()) null else it.parseObjectByKtx())
                },
                label = "路由地址",
                isRequired = false
            )
        ...
        SysMenuFormProps.icon to {
            AddTextField(
                ...
                onValueChange = {
                    state.value = state.value.copy(icon = if (it.isBlank()) null else it.parseObjectByKtx())
                },
                label = "图标",
                isRequired = false
            )
        ...
        SysMenuFormProps.order to {
            AddMoneyField(
                ...
                onValueChange = {
                    state.value = state.value.copy(order = if (it.isBlank()) null else it.parseObjectByKtx())
                },
                label = "排序",
                isRequired = false,
                currency = "CNY"
